...
import bangz.smartmute.R;
import bangz.smartmute.content.MuteRulesProvider;
...
public class MuteRulesProviderTest extends ProviderTestCase2<MuteRulesProvider> {
    ...
    private final RULE[] TEST_RULES = {
        new RULE("TestLocation01", 1, RulesColumns.RT_LOCATION,"location: 45.223, -56.764","",RulesColumns.RM_SILENT,""),
        new RULE("TestLocation02", 1, RulesColumns.RT_LOCATION,"Location:-89.45, 65.667","", RulesColumns.RM_VIBRATE,""),
        new RULE("TestWifi01",1, RulesColumns.RT_WIFI,"Wifi: netgear44","",RulesColumns.RM_VIBRATE,""),
        new RULE("TestWifi02",1, RulesColumns.RT_WIFI, "WIFI: ROYERnono","", RulesColumns.RM_SILENT,""),
        new RULE("TestTime01",1,RulesColumns.RT_TIME,"TIME: 23:15, 7:20,1111111","",RulesColumns.RM_SILENT,""),
        new RULE("TestTime02",1,RulesColumns.RT_TIME,"TIME: 13:00, 16:00,0111110","",RulesColumns.RM_SILENT,"")
    };
    ...
    public void testInserts() {
        RULE rule = new RULE("Single Test", 1, RulesColumns.RT_LOCATION,
                "location: 34.4522, -22.5443","",RulesColumns.RM_SILENT,"");
    ...
    public void testDeletes() {
        ...
        // Tries to delete rows matching the selection criteria trom the table
    ...
    private static class RULE {
        ...
        public RULE(String n, int a, int rt, String mcondition, String scondition, int rm, String desc) {
            name = n;
            actived = a;
            ruletype = rt;
